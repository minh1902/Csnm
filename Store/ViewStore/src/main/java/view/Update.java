...
public class Update extends javax.swing.JFrame {
    ...
    public Update(HomePage homePage, Integer id, String name, String price, String category) {
        initComponents();
        this.homePage = homePage;
        this.id = id;
        setValue(name, price, category);
        setCategory();
    ...
    private void setValue(String name, String price, String category){
        nameTf.setText(name);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        try {                                         
            ...
            ProductApi.updateProduct(id, name, price, category);
